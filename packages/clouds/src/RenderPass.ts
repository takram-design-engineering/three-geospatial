...
import { RenderResolveMaterial } from './RenderResolveMaterial'
import {
...
export class RenderPass extends PassBase {
  ...
  readonly currentMaterial: RenderMaterial
  readonly currentPass: ShaderPass
  private resolveRenderTarget!: RenderTarget
  readonly resolveMaterial: RenderResolveMaterial
  ...
  constructor(
    ...
    this.resolveMaterial = new RenderResolveMaterial()
