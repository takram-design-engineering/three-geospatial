...
import { BackSide, ColorManagement, Scene } from 'three'
...
const Content: FC<StoryProps> = ({
  ...
  aerialNode.correctGeometricError = false
  ...
  return (
    <>
      ...
      <EastNorthUpFrame
        ...
        height={1200}
      >
        <group scale={800} rotation-x={Math.PI / 2} rotation-y={Math.PI}>
          {/* Render the backface of the dragon with the backdrop first. */}
          <Dragon renderOrder={-1} material={material} />
          <Dragon
            material-attenuationColor={0xcccccc}
            material-attenuationDistance={200}
          />
        </group>
      </EastNorthUpFrame>
